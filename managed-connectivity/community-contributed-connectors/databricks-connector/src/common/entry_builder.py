...
def build_schemas(config, catalog_name, df_raw_schemas):
    ...
    parent_name =  nb.create_parent_name(config, entry_type, catalog_name)
...
def build_dataset(config, catalog_name, db_schema, entry_type):
